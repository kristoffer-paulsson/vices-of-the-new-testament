...
\newglossaryentry{epheuretēs kakos}
{
    name=\grc{ἐφευρετής κακός},
    description={\entrefgls{maleficent contriver}},
    sort=εφευρετης κακος@\grc{ἐφευρετής κακός}
}
...
See \entref{maleficent craving}, \entref{maleficent eye}, \entref{malevolence}, also \entref{malice}.
Found in Rom 1:30.
