...
(\textit{plēktēs}):
Thayer denotes ``([from] \grc{πλήσσω}) \ldots, (A. V. striker), bruiser, ready with a blow; a pugnacious, contentious, quarrelsome person.'' 
Then Gingrich denotes distinctly ``pugnacious man, bully.'' 
Danker connotes to G. ``[from][\grc{πλήσσω}; `smiter'] `one who is set on getting into a fight', bully.'' 
