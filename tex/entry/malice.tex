...
(\textit{kakoētheia}):
According to Grundmann, the current term denotes ``It always means `wickedness,' `malice.' In the NT it occurs only at Rom 1:29 \ldots The series shows that it is here conscious and intentional wickedness.''\bkfoot{\grc{κακοήθεια}}{3:485}{\tdntGrundmann} 
